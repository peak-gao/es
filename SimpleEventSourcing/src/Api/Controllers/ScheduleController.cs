...
using Logic.AppServices.Querys;
using Logic.Dtos;
...
namespace Api.Controllers
{
    ...
    public sealed class ScheduleController : BaseController
    {
        ...
        public ScheduleController(Messages messages)
        {
            _messages = messages;
        }

        [HttpGet]
        public IActionResult GetHistoryList(string scheduleId)
        {
            var list = _messages.Dispatch(new GetHistoryQuery(scheduleId));
            return Ok(list);
        }
